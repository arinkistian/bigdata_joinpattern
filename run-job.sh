...
IP_NAMENODE=192.168.252.78
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=jobsheet10.jar
PACKAGE_ID=org.example.App
#INPUT_FOLDER=/arinkistia/Join/js16
INPUT_FOLDER_CITY=/arinkistia/Join/City
INPUT_FOLDER_TEMPERATURE=/arinkistia/Join/Temperature
OUTPUT_FOLDER=/arinkistia/Join/Hasil
